...
1. **Offline First AI Platforms** – Tools that can run without a constant internet connection, syncing data only when online.
2. **Mobile First Delivery** – Since smartphones are more widely available than computers in Sri Lanka, learning apps should be designed primarily for mobile use.
3. **Open Source Frameworks** – We can adapt existing free AI platforms to match our curriculum and language needs.
4. **Public Private Partnerships** – Collaborations with telecom companies, NGOs, and tech innovators could subsidise access for low-income communities.
5. **Teacher Led Hybrid Models** – AI should work alongside trained teachers, not replace them, to ensure the best outcomes.
