...
/* harmony import */ var _lib_getPostComments__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4115);
...
// post single layout
const Article = ({ post , mdxContent , slug , allCategories , relatedPosts , posts , comments  })=>{
...
const getStaticProps = async ({ params  })=>{
    ...
    // comments
    const comments = (0,_lib_getPostComments__WEBPACK_IMPORTED_MODULE_6__/* .getPostComments */ .w)(single) || [];
    return {
        props: {
            post,
            mdxContent,
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,626,697,879,959,558,837,875], () => (__webpack_exec__(3711)));
